...
filePoolPath = "/data_network/summer_projects/alvesrod/Share/2023_mouse-dMRI/datasets/20181210_originalData_manipDTI_wt-hetMAP6Mice/allSubjects/t1FLASH-zeroTransformDTI_shorterNames" #Path to folder containing all images o$
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
subjectList = ["M672","M872","M874","M875","M886","M8876","M757","M857","M866","M867b","M877","M881b"] #The first 6 are WT and the last ones are het MAP6 mice
